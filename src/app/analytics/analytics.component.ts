...
export class AnalyticsComponent implements AfterViewInit {
  ...
  @ViewChild('categoriesPieCanvas') categoriesPieCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('categoriesBarCanvas') categoriesBarCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('categoriesLineCanvas') categoriesLineCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('durationsPieCanvas') durationsPieCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('durationsBarCanvas') durationsBarCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('durationsLineCanvas') durationsLineCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('priorityPieCanvas') priorityPieCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('priorityBarCanvas') priorityBarCanvas!: ElementRef<HTMLCanvasElement>;
  @ViewChild('priorityLineCanvas') priorityLineCanvas!: ElementRef<HTMLCanvasElement>;
  ...
  getCanvasElement(chartType: ChartType, dataSet: string): HTMLCanvasElement {
    ...
    switch (chartType) {
      case 'pie':
        canvas = dataSet === 'categories' ? this.categoriesPieCanvas.nativeElement :
                dataSet === 'durations' ? this.durationsPieCanvas.nativeElement :
                dataSet === 'priority' ? this.priorityPieCanvas.nativeElement : null!;
        break;
      case 'bar':
        canvas = dataSet === 'categories' ? this.categoriesBarCanvas.nativeElement :
                dataSet === 'durations' ? this.durationsBarCanvas.nativeElement :
                dataSet === 'priority' ? this.priorityBarCanvas.nativeElement : null!;
        break;
      case 'line':
        canvas = dataSet === 'categories' ? this.categoriesLineCanvas.nativeElement :
                dataSet === 'durations' ? this.durationsLineCanvas.nativeElement :
                dataSet === 'priority' ? this.priorityLineCanvas.nativeElement : null!;
        break;
      default:
  ...
  renderChartOnCanvas(ctx: CanvasRenderingContext2D, labels: string[], data: number[]): void {
    new Chart(ctx, {
